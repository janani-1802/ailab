...
def _make_multinomial_spam_data() -> Tuple[
    ...
    """
    Tiny bag-of-words style dataset.
...
if __name__ == "__main__":
    ...
    print(
        ...
        "with class-conditional normality.\n"
    )
    ...
    if acc_g >= 0.5 and acc_m >= 0.5:
        ...
        print(
            "Thus, the implementation executed, but "
            "model accuracy is low; consider revisiting "
            "data or smoothing."
        )
